...
#define TSK_ACTIVE_MM 264 /* offsetof(struct task_struct, active_mm)	@ */
...
#define MM_CONTEXT_ID 424 /* offsetof(struct mm_struct, context.id.counter)	@ */
...
#define SIZEOF_MACHINE_DESC 88 /* sizeof(struct machine_desc)	@ */
